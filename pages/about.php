      ...
      <div id="page_header" class="page about-header">
            <div class="wrapper">
                <div class="fade-in-up">
                  ...
                  <p>I'm a designer &amp; developer from Michigan.</p>
                </div>
            </div>
      </div>
                  ...
                  <!-- <div class="row">
                      <div class="col one_third">
                        ...
                        <ul class="exp_list">
                          ...
                          <li>Maytag<sup>&reg;</sup></li>
                          <li>KitchenAid<sup>&reg;</sup></li>
                          <li>JennAir<sup>&reg;</sup></li>
                          <li>Amana<sup>&reg;</sup></li>
                          <li>Gladiator<sup>&reg;</sup></li>
                          <li>Renaissance Athletic Club</li>
                          <li>The Emerald Avenue</li>
